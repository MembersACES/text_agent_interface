...
const ROUTE_TITLES: Record<string, string> = {
  ...
  "/invoicing": "Invoicing",
  "/ghg-reporting": "GHG WIP review",
  "/ghg-reporting/entities": "Linked entities",
  ...
  "/autonomous-agent/agreement-follow-up": "Agreement Follow Up",
  "/autonomous-agent/templates": "Sequence templates",
  "/autonomous-agent/resources": "Autonomous Resources",
  "/reports": "Reports",
  "/reports/activities": "Activity report",
  "/loa-upload": "Google Drive - New Member Creation",
  "/distributor-folder-creation": "Distributor Folder Creation",
