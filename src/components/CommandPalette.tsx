...
const QUICK_ACTIONS = [
  ...
  { href: "/distributors/partners", label: "Distributor partner access", icon: KeyRound, section: "Navigate" },
  { href: "/suppliers", label: "Suppliers", icon: Factory, section: "Navigate" },
