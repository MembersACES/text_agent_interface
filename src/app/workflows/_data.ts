...
export const WORKFLOW_CARD_GROUPS: { label: string; cards: WorkflowCard[] }[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Agreement Follow Up", description: "Email the member an agreement PDF and start autonomous signing follow-up", href: "/autonomous-agent/agreement-follow-up", icon: FileSignature, color: "from-indigo-500 to-violet-600" },
      ...
      { title: "Send Alinta electricity agreement", description: "Upload signed Alinta electricity EF, look up NMI(s), email LOA + agreement", href: "/alinta-electricity-agreement-request", icon: Zap, color: "from-amber-500 to-yellow-600" },
